...
\newcommand{\Titel}{Ermittlung Aerodynamischer Größen im Flugversuch mit der Do 128-6}								% Titel der Arbeit		
...
\begin{document}
	...
	\newpage
  	...
  	\include{Seiten/einleitung}
  	\include{Seiten/theorie}
  	\include{Seiten/versuch}
  	\include{Seiten/massenabschaetzung}
  	\include{Seiten/auswertung}
  	\include{Seiten/darstellung}
  	\include{Seiten/interpretation}
  	\include{Seiten/fazit}
